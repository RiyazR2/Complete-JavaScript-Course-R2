...
if (bill >= 50 && bill <= 300) {
  tip = (bill / 100) * 15;
  console.log(`“The bill was ${bill}, the tip(15%) was ${tip}, and the total value ${bill + tip}”
  `)
} else {
  tip = (bill / 100) * 20;
  console.log(`“The bill was ${bill}, the tip(20%) was ${tip}, and the total value ${bill + tip}”
  `)
}

/*
// this solution by Jonas Sir
let bill = 275
