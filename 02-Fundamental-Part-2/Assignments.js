...
/*
// Assignment 12 LECTURE: Looping Backwards and Loops in Loops
...
for (let i = 0; i < listOfNeighbours.length; i++) {
    //not understand question so the below code is copy of JONAS
...
/* Assignment 13 LECTURE: The while Loop
...
while (i < populationArray.length) {
    const perc = percentageOfWorld1(populationArray[i]).toFixed(2);
...
// ********************************************** Last 2 Assignment Not understand ***********************