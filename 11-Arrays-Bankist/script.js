...
const x = new Array(7); // created 7 empty place
console.log(x);

// fill(value to be filled,starting index, ending index)
x.fill(1, 3, 5);
console.log(x);
...
/// 2. how many atleast 1000 deposits
...
/// 3. Sum of all Deposits and withdrawals
const sums = accounts
